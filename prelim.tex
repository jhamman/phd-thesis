...
In Chapter \ref{chap:streamflow}, I present a new river routing scheme (RVIC) for coupled climate models, again evaluating the model in comparison to in situ observations and model based datasets.
...
Thank you also to the members of the Computational Hydrology Group, it has been a please working along side all of you.
Much of the research included in this dissertation was made possible by the productive collaboration of Regional Arctic System Model (RASM) team.
...
At the time of writing, Chapter \ref{chap:rasm} has been published as \citet{Hamman_2016a} with the \textit{Journal of Climate}.
