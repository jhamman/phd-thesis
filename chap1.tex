...
Global climate models (GCMs) generally agree that global temperature will increases in response to increasing atmospheric carbon-dioxide.
...
For example, \citet{Alkama_2013}, reviewed streamflow statistics from a selection of GCMs in the Coupled Model Intercomparison Project Phase 5 (CMIP5) collection \citep{Taylor_2012}, and reported that some GCMs have annual regional biases that exceed 50\%.
...
\begin{mdframed}
  ...
  \begin{enumerate}
    ...
    \item How do changes in Arctic sea ice extent impact precipitation over the high-latitude land areas in the winter?
  \end{enumerate}
\end{mdframed}
